...
!	      call read_wfn_header(jumpstartfile,.true.)  ! reads in header to harvest information about basis
		  
!		  call read_info4jumpstart1
...
!......................................FINISHED MAKING JUMPS ..............
   ...
   if ( menu_char == 'n' .or. menu_char == 's' .or. menu_char == 'd' .or. menu_char=='g' &
       .or. menu_char == 'ns' .or. menu_char=='ne' .or. menu_char == 'np' .or. menu_char=='wh') then
