...
call BMPI_BCAST(istatestart,1,0,icomm,ierr)
call BMPI_BCAST(istatestop,1,0,icomm,ierr)
call BMPI_BCAST(fstatestart,1,0,icomm,ierr)
call BMPI_BCAST(fstatestop,1,0,icomm,ierr)
...
if(.not.write_select(1))then
	call wfn_readeigenvec(oldwfnfile,frag2, fcomm2, vec2, 1, ei,xjj,xtt)
	e(1)=ei
end if
...
do i = 1, nkeep
	if(write_select(i))then
        call wfn_readeigenvec(oldwfnfile,frag2, fcomm2, vec2, i, ei,xjj,xtt)
		e(i)=ei
...
36                     format(2i5, 2f10.5)
  ...
  if(iproc == 0)then
	  print*,' ++++++++++++++++++++++++++++'
	  print*,' Output written to .dres file '
	  print*,' in proton-neutron format '
	  print*,' +++++++++++++++++++++++++++'
     write(resultfile,*)'+++++++++++++++++++++++++++++++++++++++++++++'
     write(resultfile,*)' '
     write(resultfile,*)' Definition of density matrices : '
