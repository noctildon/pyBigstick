...
subroutine print_fragops
	...
	if(nproc > 1 .or. menu_char=='m')print*,fragcount,' out of ',nfragments**2,' frag 2 frag have ops '
	print*,' weighted average # of operations = ',avgopsperfrag/float(nfragments)**2
	if(nproc > 1 .or. menu_char=='m')print*,' min/max = ',minopsperfrag,maxopsperfrag
...
! 	print*,iob,memrequired,avgopstore
    ...
    call BMPI_Barrier(icomm,ierr)  ! for debugging purposes only
	return
