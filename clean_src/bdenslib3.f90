...
! OMP ADDED 7.9.5; 
! OMP disabled 7.9.7; appears to cause problems in some W-truncated cases
!!$OMP parallel do private(a,b,statei,statef,statei0,statef0,csd,xme), reduction(+:p1bopme)
...
!!$OMP parallel do private(a,b,statei,statef,statei0,statef0,csd,xme), reduction(+:n1bopme)
     do xjmp = xjmpstart,xjmpend
!--------- FETCH MATRIX ELEMENT
        a    = n1b_cop(xjmp) 
        b    = n1b_dop(xjmp)
...
!--------- LOOP OVER 1-BODY JUMPS IN THIS SECTOR JUMPS.............
! OMP ADDED 7.9.5
! OMP disabled 7.9.7 to address bug in some cases
!!$OMP parallel do private(a,b,statei,statef,statei0,statef0,csd,xme), reduction(+:n1bopme)
     do xjmp = xjmpstart,xjmpend
!--------- FETCH MATRIX ELEMENT
        a    = n1b_cop(xjmp) 
